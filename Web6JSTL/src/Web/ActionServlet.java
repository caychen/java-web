...
public class ActionServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
		...
		if (action.equals("/list")) {
			...
			int perPage = Integer.parseInt(getServletConfig().getInitParameter("perPage"));
			
			
			try {
				// 使用DAO来访问数据库
				List<Employee> employees = dao.findAllByPage(page, perPage);
				int totalPages = dao.totalPages(perPage);
